...
import { createContact, clearCreatingContactError } from '../../actions/contacts'
...
class NewContactForm extends React.Component {
    ...
    componentWillMount () {
        if (this.props.creatingContactError) {
            this.props.clearCreatingContactError()
        }
    }
    ...
    render () {
        const error = this.props.creatingContactError
        ...
        return (
            <Form onSubmit={e => this.onSubmit(e)}>
                ...
                <Button
                    role="button"
                    color="primary"
                    disabled={this.props.creatingContact}
                >Save</Button>
            </Form>
        )
    }
...
const mapStateToProps = store => ({
    ...
    creatingContact: store.get('creatingContact'),
})
